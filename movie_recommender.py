...
def main():
    ...
    try:
        ...
        if chosen_genre:
            ...
            top10_movies_per_genre_list = genre_top_df['title'][:10].tolist()
            favorite_movie = st.selectbox(label="Select your favorite movie", options=top10_movies_per_genre_list)
            if favorite_movie:
